 ...
 * @author sgsic
 */
public class PantallaSesionAdmin extends javax.swing.JFrame {

    /**
     * Creates new form PantallaSesionAdmin
     */
    public PantallaSesionAdmin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PantallaSesionAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PantallaSesionAdmin().setVisible(true);
            }
        });
    }
